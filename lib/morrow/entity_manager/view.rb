# Created from Morrow::EntityManager#get_view, this class maintains a snapshot
# of Entity ID's & Component instances that meet a certain criteria.
#
# This class is used to pass data to the Systems.
class Morrow::EntityManager::View
